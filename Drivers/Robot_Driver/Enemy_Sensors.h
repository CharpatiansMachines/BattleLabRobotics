...
#define ENEMY_POSITIONS_STATES_NO 36  //max number of states of enemy position
...
/**
 * @param enemyPosition1
 * @param enemyPosition2
 * @return the distance between 2 Enemy Positions
 */
